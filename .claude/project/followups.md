...
### atomic-update-doctor-F-1 — `Resolved()` bool default heuristic piggybacks on intensity sentinel


`atomic/internal/config/render.go:69`
...
Origin: docs/spec/atomic-update-doctor.md, iter 2 reviewer (CP-3..CP-7 re-review). Deferred to project followups at Phase 3 finalize 2026-05-22.
