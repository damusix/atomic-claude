...
- **→ doctor**: `atomic/internal/profile/` is exercised by doctor category 10 (`checks_profile.go`). Changes to `CaptureEnv` or `RenderStub` (profile package, this domain) affect what doctor checks as "profile wired".
