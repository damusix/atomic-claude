...
- [`docs/guides/knowledge-base.md`](../../../docs/guides/knowledge-base.md) — guide: extending a realm wiki into a full knowledge base. Covers realm layout, raw-material capture surfaces (research, tickets, notes), fingerprint synthesis, and the pattern for compiling a Karpathy-style wiki with Claude. User-facing.
