...
│   │   │   ├── fix.go (77ed97b, 408L, 12132ch, 12164B)
...
│   │   │   └── manifest.go (08eb69e, 70L, 10199ch, 10199B)
│   │   ├── followups/ (15)
...
│   ├── atomic-improve.md (9bddf32, 645L, 38007ch, 38264B)
...
│   │   ├── concepts.md (3344de1, 208L, 14578ch, 14676B)
...
│   │   ├── atomic-doctor.md (c181c45, 303L, 18124ch, 18192B)
...
│   │   └── user-profile.md (1074ae6, 234L, 17548ch, 17612B)
...
- Markdown: 34018 LOC (52%), 238 files (62%)
- Go: 27985 LOC (42%), 126 files (32%)
