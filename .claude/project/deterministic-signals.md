---
generated_at: 2026-06-03T07:25:25Z
atomic_version: dev
---
...
│   └── config.mts (643c447, 154L, 6536ch, 6540B)
├── agents/ (9)
...
│   ├── cmd/ (3)
│   │   ├── atomic/ (2)
│   │   │   ├── main.go (8f41a6c, 967L, 31720ch, 31760B)
...
│   │   │   ├── doctor.go (84d51ae, 116L, 3842ch, 3872B)
...
│   │   │   └── manifest.go (8148dca, 71L, 10369ch, 10369B)
│   │   ├── followups/ (15)
...
│   │   │   ├── signals.go (da80496, 411L, 13377ch, 13401B)
...
│   ├── CHANGELOG.md (7ab78fc, 210L, 13540ch, 13546B)
...
│   ├── commit-and-merge.md (99b3aeb, 198L, 10208ch, 10286B)
│   ├── commit-and-pr.md (ca15873, 149L, 7474ch, 7540B)
│   ├── commit-and-push.md (28bb518, 126L, 6619ch, 6679B)
│   ├── commit-and-squash.md (83ec519, 222L, 11589ch, 11693B)
│   ├── commit-only.md (54700c0, 102L, 5851ch, 5899B)
...
│   ├── merge-to-main.md (ef815c0, 112L, 6031ch, 6069B)
...
│   ├── squash-and-merge.md (fe19f49, 212L, 10786ch, 10872B)
│   ├── squash-only.md (3e11dea, 128L, 6794ch, 6852B)
...
│   │   └── workflow.md (349b5a1, 156L, 8596ch, 8718B)
│   ├── spec/ (24)
│   │   ├── artifact-templates.md (9c31bdb, 122L, 13661ch, 13732B)
│   │   ├── atomic-binary.md (499daad, 729L, 40166ch, 40520B)
│   │   ├── atomic-doctor.md (3104754, 357L, 24434ch, 24543B)
...
│   └── index.md (fb9cdbb, 148L, 6518ch, 6550B)
├── output-styles/ (1)
...
│       ├── signals-gate.md (ba592a3, 17L, 1274ch, 1282B)
...
├── README.md (a440280, 183L, 10096ch, 10639B)
...
└── release-please-manifest.json (1b6ce00, 3L, 24ch, 24B)
...
- Markdown: 37546 LOC (50%), 263 files (61%)
- Go: 33490 LOC (44%), 142 files (33%)
- JSON: 2295 LOC (3%), 5 files (1%)
