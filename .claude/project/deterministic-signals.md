---
generated_at: 2026-05-25T13:52:44Z
...
│   ├── logo.png (ab6ba7f, 188L, 55076ch, 57023B)
│   ├── share-image.png (48f0d87, 1063L, 339066ch, 352494B)
│   └── starburst.png (f3152bc, 38393L, 6018060ch, 6223994B)
├── atomic/ (7)
│   ├── cmd/ (3)
│   │   ├── atomic/ (2)
│   │   │   ├── main.go (bb188a4, 822L, 26236ch, 26266B)
│   │   │   └── main_test.go (429247c, 406L, 13646ch, 13656B)
│   │   ├── bundle-mirror/ (2)
...
│   │   │   └── manifest.go (7c29f25, 70L, 10205ch, 10205B)
│   │   ├── followups/ (15)
...
│   ├── CHANGELOG.md (e782241, 113L, 8209ch, 8211B)
...
│   ├── commit-and-merge.md (19d3021, 136L, 6396ch, 6438B)
│   ├── commit-and-pr.md (3e01b42, 95L, 4364ch, 4398B)
│   ├── commit-and-push.md (6cc3097, 72L, 3509ch, 3537B)
│   ├── commit-and-squash.md (f0535f5, 115L, 5988ch, 6030B)
│   ├── commit-only.md (e8b14a5, 48L, 2741ch, 2757B)
...
│   ├── squash-and-merge.md (1e6e859, 150L, 7081ch, 7131B)
│   ├── squash-only.md (302ac6d, 74L, 3791ch, 3817B)
...
│   ├── atomic-tdd/ (1)
│   │   └── SKILL.md (29c6b0a, 81L, 3421ch, 3439B)
│   └── atomic-verify/ (1)
...
│       ├── doc-impact.md (e2ecaa4, 14L, 836ch, 844B)
...
├── CLAUDE.md (bcd459c, 193L, 20347ch, 20515B)
├── Dockerfile (0e5b6e5, 61L, 2316ch, 2592B)
├── LICENSE (42eaf96, 21L, 1070ch, 1070B)
├── Makefile (58b17de, 37L, 1371ch, 1371B)
├── README.md (3c2afbc, 273L, 14889ch, 15494B)
├── claude.local.md (07ed375, 225L, 19263ch, 19322B)
...
└── release-please-manifest.json (ae60bd5, 3L, 24ch, 24B)
...
- Markdown: 27903 LOC (47%), 231 files (61%)
- Go: 27417 LOC (46%), 124 files (33%)
