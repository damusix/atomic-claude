...
├── agents/ (9)
│   ├── atomic-builder.md (a55e476, 92L, 4114ch, 4162B)
│   ├── atomic-claude-merger.md (1fffe83, 102L, 4698ch, 4720B)
│   ├── atomic-git-scout.md (5cb89ff, 134L, 6274ch, 6304B)
│   ├── atomic-haiku.md (7680878, 40L, 2611ch, 2625B)
│   ├── atomic-investigator.md (24a3059, 72L, 2176ch, 2218B)
│   ├── atomic-reviewer.md (bd84534, 147L, 7889ch, 8038B)
│   ├── atomic-signals-inferrer.md (ab05247, 333L, 15639ch, 15799B)
│   ├── atomic-strategist.md (6cdaaf0, 100L, 4656ch, 4682B)
│   └── atomic-surgeon.md (48bcc75, 77L, 3159ch, 3195B)
├── assets/ (4)
...
│   │   │   └── manifest.go (f18d087, 70L, 10205ch, 10205B)
│   │   ├── followups/ (15)
...
├── commands/ (31)
│   ├── _templates/ (2)
│   │   ├── implementer-prompt.md (e52fcbd, 106L, 3098ch, 3154B)
│   │   └── reviewer-prompt.md (9f2df9a, 135L, 3782ch, 3886B)
...
│   ├── atomic-setup.md (2084b8f, 351L, 14885ch, 14991B)
...
├── skills/ (8)
│   ├── atomic-commit/ (1)
│   │   └── SKILL.md (b4327c9, 102L, 4102ch, 4118B)
│   ├── atomic-debug/ (1)
│   │   └── SKILL.md (ab40f81, 118L, 4722ch, 4763B)
│   ├── atomic-documentation/ (1)
│   │   └── SKILL.md (d3382f8, 206L, 11834ch, 11896B)
│   ├── atomic-prose/ (1)
│   │   └── SKILL.md (d280de1, 147L, 10166ch, 10189B)
│   ├── atomic-review/ (1)
│   │   └── SKILL.md (66968a9, 76L, 2937ch, 2986B)
│   ├── atomic-signals/ (1)
│   │   └── SKILL.md (c106d47, 94L, 6652ch, 6692B)
│   ├── atomic-tdd/ (1)
│   │   └── SKILL.md (c1c3451, 98L, 4365ch, 4387B)
│   └── atomic-verify/ (1)
│       └── SKILL.md (a6eebb6, 74L, 2576ch, 2608B)
├── templates/ (2)
│   ├── commands/ (31)
│   │   ├── _templates/ (2)
│   │   │   ├── implementer-prompt.md (e52fcbd, 106L, 3098ch, 3154B)
...
- Markdown: 30424 LOC (49%), 236 files (62%)
- Go: 27985 LOC (45%), 126 files (33%)
