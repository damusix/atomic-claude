---
generated_at: 2026-05-30T14:35:40Z
...
│   │   │   └── main_test.go (cb67902, 573L, 20318ch, 20340B)
│   │   ├── bundle-mirror/ (2)
...
│   │   │   └── manifest.go (d7ed147, 70L, 10199ch, 10199B)
│   │   ├── followups/ (15)
...
│   │   ├── hooks/ (3)
│   │   │   ├── hooks.go (a9d5c24, 380L, 11246ch, 11274B)
│   │   │   ├── hooks_hujson.go (2dd38d0, 313L, 8764ch, 8768B)
│   │   │   └── hooks_test.go (87abaa5, 1175L, 37733ch, 37755B)
│   │   ├── ids/ (2)
...
│   ├── atomic-setup.md (41c3b04, 359L, 14940ch, 15048B)
...
│   │   ├── atomic-binary.md (f6adfbc, 694L, 34492ch, 34818B)
...
- Markdown: 36129 LOC (50%), 251 files (61%)
- Go: 31772 LOC (44%), 137 files (33%)
