---
generated_at: 2026-05-28T15:55:34Z
...
│   │   │   ├── checks_profile.go (5378a73, 68L, 2403ch, 2403B)
│   │   │   ├── checks_profile_test.go (c56868e, 93L, 3089ch, 3089B)
...
│   │   │   └── manifest.go (8695987, 70L, 10199ch, 10199B)
│   │   ├── followups/ (15)
...
│   │   ├── profile/ (2)
│   │   │   ├── profile.go (91e65a6, 93L, 2858ch, 2862B)
...
│   ├── CHANGELOG.md (217b358, 141L, 9519ch, 9521B)
...
│   ├── atomic-help.md (7625523, 264L, 14516ch, 14662B)
...
│   │   └── user-profile.md (197f775, 206L, 10066ch, 10106B)
│   ├── guides/ (3)
...
│   │   ├── concepts.md (a441258, 276L, 17287ch, 17391B)
...
│   │   └── user-profile.md (f8a47d1, 273L, 20560ch, 20648B)
...
├── CLAUDE.md (5501d6c, 224L, 24323ch, 24515B)
├── Dockerfile (0e5b6e5, 61L, 2316ch, 2592B)
├── LICENSE (42eaf96, 21L, 1070ch, 1070B)
├── Makefile (58b17de, 37L, 1371ch, 1371B)
├── README.md (6554a5d, 175L, 8206ch, 8749B)
├── claude.local.md (3aca3b4, 285L, 25199ch, 25296B)
...
└── release-please-manifest.json (25b50ba, 3L, 24ch, 24B)
...
- Markdown: 34251 LOC (51%), 238 files (61%)
- Go: 28633 LOC (43%), 131 files (33%)
