---
generated_at: 2026-05-26T19:58:53Z
...
│   ├── atomic-signals-inferrer.md (e92a3c8, 341L, 16451ch, 16617B)
...
│   │   │   ├── checks_refs.go (477404b, 54L, 1519ch, 1521B)
...
│   │   │   └── manifest.go (e05a8d7, 70L, 10205ch, 10205B)
│   │   ├── followups/ (15)
...
│   ├── CHANGELOG.md (9fb6e25, 133L, 9072ch, 9074B)
...
│   ├── atomic-compress.md (4ce270f, 67L, 3252ch, 3264B)
│   ├── atomic-help.md (5394e1e, 116L, 5562ch, 5624B)
│   ├── atomic-plan.md (59230e0, 304L, 15028ch, 15170B)
│   ├── atomic-setup.md (c6f3258, 359L, 14931ch, 15039B)
│   ├── commit-and-merge.md (7c188df, 182L, 8804ch, 8874B)
│   ├── commit-and-pr.md (6a9f871, 141L, 6772ch, 6834B)
│   ├── commit-and-push.md (6ea5d10, 118L, 5917ch, 5973B)
│   ├── commit-and-squash.md (1d600d5, 206L, 10185ch, 10281B)
│   ├── commit-only.md (9f7b942, 94L, 5149ch, 5193B)
│   ├── documentation.md (18290d7, 327L, 11408ch, 11518B)
│   ├── follow-up.md (46c2e02, 380L, 15266ch, 15436B)
│   ├── git-cleanup.md (5724c55, 192L, 7820ch, 7892B)
│   ├── merge-to-main.md (00805ff, 104L, 5329ch, 5363B)
│   ├── pr-only.md (1c5e6b1, 51L, 2840ch, 2860B)
│   ├── pressure-test.md (992604f, 169L, 13266ch, 13360B)
│   ├── push-only.md (5279554, 41L, 2427ch, 2449B)
│   ├── refresh-signals.md (ccc6701, 178L, 5193ch, 5227B)
│   ├── remind-me.md (41433cb, 184L, 7226ch, 7275B)
│   ├── report-issue-with-atomic.md (8b8f47f, 109L, 3998ch, 4032B)
│   ├── report-issue.md (6bb1180, 98L, 2742ch, 2772B)
│   ├── review-branch.md (d560b3d, 129L, 3595ch, 3617B)
│   ├── session-report.md (db55169, 88L, 4365ch, 4393B)
│   ├── squash-and-merge.md (787472f, 196L, 9382ch, 9460B)
│   ├── squash-only.md (dde50ad, 120L, 6092ch, 6146B)
│   ├── subagent-diagnose.md (323ab21, 213L, 14698ch, 14825B)
...
│   │   ├── commands.md (a983856, 77L, 4293ch, 4297B)
│   │   ├── concepts.md (1354aca, 200L, 14130ch, 14224B)
...
│   │   ├── atomic-doctor.md (6a74142, 303L, 18130ch, 18198B)
...
│   │   ├── documentation-as-maintenance.md (f280aff, 215L, 14754ch, 14826B)
...
│   │   ├── signals-workflow.md (f2282fd, 393L, 22994ch, 23128B)
...
│   │   └── SKILL.md (f4ada4a, 206L, 11846ch, 11914B)
│   ├── atomic-prose/ (1)
│   │   └── SKILL.md (88cd142, 140L, 9940ch, 9963B)
│   ├── atomic-review/ (1)
│   │   └── SKILL.md (418f8a8, 84L, 3110ch, 3159B)
│   ├── atomic-signals/ (1)
│   │   └── SKILL.md (d7a8b6a, 110L, 6912ch, 6952B)
│   ├── atomic-tdd/ (1)
...
├── CLAUDE.md (c7b2266, 221L, 22852ch, 23040B)
...
├── claude.local.md (d9dda99, 240L, 20026ch, 20087B)
...
└── release-please-manifest.json (5f3ed64, 3L, 24ch, 24B)
...
- Markdown: 31058 LOC (49%), 236 files (62%)
- Go: 27985 LOC (44%), 126 files (33%)
