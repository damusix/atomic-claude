...
paths: ["atomic/internal/serve/**", "atomic/internal/mdlink/**", "atomic/internal/frontmatter/**"]
---

Domain: serve. Local read-only web UI over the wiki and the code graph.

- Map: docs/wiki/serve.md
- Contracts: docs/spec/atomic-serve.md
- Reference: docs/reference/serve.md
