...
var commands = []Command{
	...
	},
	{
		...
		Description: "Install Atomic into explicitly selected harness instances",
	},
	{
		Path:        []string{"harness", "list"},
		Args:        "",
		Flags:       []string{"--json"},
		Description: "List discovered and enrolled instances",
	},
	{
		Path:        []string{"harness", "status"},
		Args:        "[<target-key>]",
		Flags:       []string{"--json"},
		Description: "Report enrolled target and shared-resource state",
	},
	{
	...
	{
		Path:        []string{"harness", "adopt"},
		Args:        "[claude]",
		Flags:       []string{"--acknowledge-snapshot", "--dry-run", "--instance", "--json", "--leave-unowned", "--replace", "--yes"},
		Description: "Adopt a verified legacy Claude install",
	},
	{
		Path:        []string{"harness", "repair"},
		Args:        "",
		Flags:       []string{"--dry-run", "--harness", "--instance", "--json", "--yes"},
		Description: "Reconverge already-enrolled targets",
	},
	{
		Path:        []string{"harness", "diff"},
		Args:        "",
		Flags:       []string{"--dry-run", "--harness", "--instance", "--json", "--yes"},
		Description: "Report native difference from the selected generation",
	},
	{
	...
	},
	{
		...
		Args:        "",
		Flags:       []string{"--dry-run", "--harness", "--instance", "--json", "--yes"},
		Description: "Report rule tier, digest, coverage, and conflict state",
	},
	{
		Path:        []string{"harness", "rules", "sync"},
		Args:        "",
		Flags:       []string{"--dry-run", "--harness", "--instance", "--json", "--yes"},
		Description: "Converge rule and steering projections for enrolled targets",
	},
	{
		Path:        []string{"state", "adopt"},
		Args:        "",
		Flags:       []string{"--clear", "--dir", "--dry-run", "--json"},
		Description: "Select this repository's state root",
	},
	{
	...
	},
	{
		...
		Description: "Write the steering loader pair and the scope marker for --scope repo|realm (idempotent)",
	},
	{
