...
1. Run `atomic docs scan` (deterministic heading extraction; falls back to a shell filesystem walk if binary absent). Lists discovered doc files with H1 + first 3 H2s.
