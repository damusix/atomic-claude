...
var wantCobraSubcommandMeta = []struct {
	...
	{[]string{"hooks", "post-tool-use"}, "", "Handle PostToolUse hook payload"},
	{[]string{"hooks", "stop"}, "", "Handle Stop hook payload; exit 2 to block"},
	{[]string{"hooks", "install"}, "", "Install Claude Code hooks"},
	{[]string{"hooks", "uninstall"}, "", "Remove Claude Code hooks"},
