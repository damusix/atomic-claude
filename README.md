...
| **Discipline skills** | Ten that auto-fire on natural language: TDD, verify, debug, commit, review, prose, doc-routing, wiki/bucket routing, visual-options, legible re-render. | [skills](docs/reference/skills.md) |
