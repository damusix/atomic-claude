{{define "worktree-cleanup-prompt"}}Worktree check: `git worktree list`. If the feature branch lived in a linked worktree (typically `.claude/worktrees/<feature>/`), ask the user:
