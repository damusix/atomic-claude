...
7. **Clean up session reports** — on successful commit, delete the `reports`-resolved dir from step 2. The reports were consumed by the commit message. If the commit failed, leave them for the next attempt.
