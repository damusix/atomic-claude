...
echo ""
echo "That enrolls the selected harness instance and converges it: AGENTS.md"
echo "steering, agents, commands, skills, output-styles, and rules, plus"
echo "session-start hook registration for Claude. Use --dry-run to preview and"
echo "--instance <root> to name a non-default target."
echo ""
