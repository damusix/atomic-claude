...
echo ""
echo "To install the artifact bundle (CLAUDE.md, agents, commands, skills,"
echo "output-styles, rules) into ~/.claude/ and register the session-start hook,"
echo "run:"
echo ""
echo "    atomic claude install"
echo ""
echo "That command will print next steps for activating the output style and"
echo "initializing project signals. Pass --no-hooks to skip hook registration."
echo ""
