---
type: Domain
description: User config, state dir (profile.md, config.toml), session hooks, reminders, follow-ups, self-update; cold-op briefs embedded in binary via coldprompt package; repo-scoped .claude/atomic.toml ignore-glob config for the code-intel indexer.
---
