...
`checks_config.go` — imports [`atomic/internal/config`](../../atomic/internal/config) directly. Validates config file structure, known key set (now including `harness.dir`), and value constraints.
