...
| Multi-agent inference pipeline: orchestrator + per-domain sub-agents + reviewers | `agents/atomic-wiki-inferrer.md` | Agent prompt rewritten for orchestrator role |
