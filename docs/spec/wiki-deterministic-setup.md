...
- No change to `.signalsignore` or any other `setup-wiki.md` heredoc besides the steering one.
...
| 3 | `setup-wiki.md` steering fix, stale `signals-steering.md` wording cleanup, and `atomic-help.md` one-line mention | `templates/commands/setup-wiki.md:74,106,180-213` (audit row, propose row, apply section), `commands/setup-wiki.md` (rendered), `claude.local.md:~200` (this repo, not templated/bundled), `skills/atomic-wiki/references/repo.md:73,203` (steering wording), `templates/commands/atomic-help.md:~125` (`binary`/`cli` topic row), `commands/atomic-help.md` (rendered), `atomic/internal/embedded/bundle/**` (regen) | atomic-implementer (feature) | 7 | SC rows 9-12; MISSING-scan zero lines; `make render` + `make -C atomic bundle` parity clean |
