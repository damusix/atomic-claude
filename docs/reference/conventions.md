...
- When `/subagent-implementation` is about to start significant work, it prompts whether to use an isolated worktree. Already inside `.worktrees/*`? It skips the prompt.
